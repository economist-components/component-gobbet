    ...
    return (
      <Gobbet className="gobbet" showShareBar={true} title={customHeader}>
        <ImageCaption caption="Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget \
          ...
          augue velit cursus nunc," src="http://lorempixel.com/g/300/169/food" textposition="top" />
      </Gobbet>
    );
  }
}
...
export default (
  <div>
    ...
    <Gobbet className="gobbet" showShareBar={true} sharebar={customSharebar}>
      ...
      Sed consequat, leo eget bibendum sodales, augue velit cursus nunc," src="http://lorempixel.com/g/300/169/food"
      textposition="top" />
    </Gobbet>
  </div>
);
